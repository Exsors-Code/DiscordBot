...
const PANEL_UPDATE_THROTTLE = 1500;
...
async function updatePanel(client, channelId, force = false) {
    ...
    try {
        ...
        if (!vc) { activeVoices.delete(channelId); return; }
        ...
        await msg.edit({
            embeds: [buildPanelEmbed(vc, data)],
            components: buildPanelButtons(data)
        });
    } catch (e) { /* silent */ }
}
